...
class ExecutivePaymentReport extends StatefulWidget {
  const ExecutivePaymentReport({Key? key}) : super(key: key);

  @override
  State<ExecutivePaymentReport> createState() => _ExecutivePaymentReportState();
}
...
class _ExecutivePaymentReportState extends State<ExecutivePaymentReport>
...
class UpdateInvoiceView extends StatefulWidget {
  @override
  _UpdateInvoiceViewState createState() => _UpdateInvoiceViewState();
}

class _UpdateInvoiceViewState extends State<UpdateInvoiceView> {
              ...
              Expanded(
                child: TextFormField(
                  ...
                  controller: TextEditingController(
                    text: _dateOfPayment != null
                        ? "${_dateOfPayment!.year}/${_dateOfPayment!.month.toString().padLeft(2, '0')}/${_dateOfPayment!.day.toString().padLeft(2, '0')}"
                        : "",
                  ),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        // Replace with file picker functionality
                        // e.g., using file_picker package
                        setState(() {
                          _proofOfPaymentFileName = "selected_file.pdf";
                        });
                      },
                      child: const Text(
                        "Choose File",
          ...
          Expanded(
            child: DataTable(
              ...
              headingRowColor: MaterialStateColor.resolveWith(
                (states) => Constants.ftaColorLight,
              ),
              columns: [
                DataColumn(label: StyledHeader('Date Of Payment')),
                DataColumn(label: StyledHeader('Reference')),
                DataColumn(label: StyledHeader('Paid Amount')),
              ],
                  ...
                  .map(
                    (history) => DataRow(
                      cells: [
                        ...
                        DataCell(Text(history['reference'] ?? '')),
...
/// A styled column header widget
class StyledHeader extends StatelessWidget {
  final String title;

  const StyledHeader(this.title);
